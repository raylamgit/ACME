      ...
      *| DATE GENERATED: 06/25/2021 12:27                              |
      *| ID: 492daf23-4028-433e-8aaa-d5cedc6685c2                      |
      *+---------------------------------------------------------------+
      *+---------------------------------------------------------------+
      *| TEST_TEST1                                                    |
      ...
      *+---------------------------------------------------------------+
       ...
       1 DFHCOMMAREA.
         ...
         7 CA-C-FILLER PIC X(31854).
          7 CA-C-FILLER-AZ REDEFINES CA-C-FILLER.
          8 PIC X(31854) DISPLAY.
      ...
      *+---------------------------------------------------------------+
       ...
       1 AZ-TEST-EXPECTED-DATA-VALUE.
          ...
          3 ZUT0000003D.
            5 PIC X(19) DISPLAY VALUE 'ROOM@TBHOLDINGS.COM'.
            5 PIC X(236) DISPLAY VALUE SPACES.
          3 ZUT0000003E.
            5 PIC X(255) DISPLAY VALUE SPACES.
          3 ZUT0000003F.
            ...
            5 PIC X(10) VALUE X'40404040404040404040'.
            5 PIC X(10) VALUE X'40404040404040404040'.
            5 PIC X(10) VALUE X'40404040C10000030000'.
            5 PIC X(10) VALUE X'00027EF4C5D5C4400000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'0000E4F0F0F0F1F4F8F0'.
            5 PIC X(10) VALUE X'40404040404040404040'.
            5 PIC X(10) VALUE X'40404040404040404040'.
            5 PIC X(10) VALUE X'40404040404040404040'.
            5 PIC X(10) VALUE X'40404040404040404040'.
            ...
            5 PIC X(10) VALUE X'F1F4F8F0E4F0F0F0F1F4'.
            5 PIC X(10) VALUE X'F8F0C8C1D5C30F9426A0'.
            5 PIC X(10) VALUE X'0F9426A0000000000F94'.
            5 PIC X(10) VALUE X'96D8000000000000AE98'.
            5 PIC X(10) VALUE X'000000000F9496D80000'.
            5 PIC X(10) VALUE X'AE78D4C2D3D200050102'.
            5 PIC X(10) VALUE X'0000AE70FFFFFFFF9035'.
            5 PIC X(10) VALUE X'5FFC0000000000000000'.
            5 PIC X(10) VALUE X'0F954562000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            ...
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'0000C9D5E3E3E2E34040'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'E2D8D3C4C14040400000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000000000000000'.
            5 PIC X(10) VALUE X'00000000E2D8D3C4C140'.
       ...
       1 AZ-COMPARE-WORK-ITEMS.
          ...
          3 ZUT00000061 PIC X(63708) OCCURS 2.
       01 AZ-CONVERT.
         03 AZ-CONVERT-HEXIN  PIC X(1).
         03 AZ-CONVERT-HEXVAL PIC X(2).
         03 AZ-HEXSTR PIC X(16) VALUE "0123456789ABCDEF".
      ...
      * EVALUATE OUTPUT VALUE
           ...
           ZUT0000005F(2)
             ...
             PERFORM THROW-ASSERTION
           END-IF
           IF CA-C-FILLER-AZ OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA = ZUT0000003F THEN
             CONTINUE
           ELSE
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 31854
               MOVE CA-C-FILLER-AZ OF CA-CLAIM OF CA-POLICY-REQUEST OF
           DFHCOMMAREA(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000061(1)(AZ-J:2)
             END-PERFORM
             PERFORM VARYING AZ-I FROM 1 BY 1 UNTIL AZ-I > 31854
               MOVE ZUT0000003F(AZ-I:1) TO AZ-CONVERT-HEXIN
               PERFORM CONVERT
               COMPUTE AZ-J = AZ-I * 2 - 1
               MOVE AZ-CONVERT-HEXVAL TO ZUT00000061(2)(AZ-J:2)
             END-PERFORM
      ...
      *+---------------------------------------------------------------+
       ...
       01 AZ-TESTCASE-ID        PIC X(36)
           VALUE '492daf23-4028-433e-8aaa-d5cedc6685c2'.
       LINKAGE SECTION.
       01 AZ-TEST               PIC X(80).
